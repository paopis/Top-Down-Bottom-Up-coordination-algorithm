...
$INCLUDE C:\Users\pisciell.WIN-NTNU-NO\Desktop\TDBU\SmallLinkExp\SmallLink\CGE-4sec_mcp_orient.GMS
...
****************************
$SETGLOBAL run calib
$if "%FLAG_CGE%" == "MCP" $include C:\Users\pisciell.WIN-NTNU-NO\Desktop\TDBU\SmallLinkExp\solve_display_LPMCP_init.gms
*************************
...
$SETGLOBAL run TIMES
$if "%FLAG_CGE%" == "MCP" $include C:\Users\pisciell.WIN-NTNU-NO\Desktop\TDBU\SmallLinkExp\solve_display_LPMCP.gms
